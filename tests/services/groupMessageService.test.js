...
describe('groupMessageService', () => {
  ...
  describe('fetchGroupMessagesRaw', () => {
    test('should call cometchatApi.fetchMessages with correct parameters', async () => {
      ...
      const result = await groupMessageService.fetchGroupMessagesRaw('room-123', customParams);
    ...
    test('should return empty array on API error', async () => {
      ...
      const result = await groupMessageService.fetchGroupMessagesRaw('room-123');
